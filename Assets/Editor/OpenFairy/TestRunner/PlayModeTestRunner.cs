...
namespace OpenFairy.UGUI.Editor
{
    ...
    // 用法：Tools/OpenFairy/Run PlayMode Tests（或 MCP ExecuteMenuItem），跑完读 Temp/OpenFairyPlayModeResults.txt。
    [InitializeOnLoad]
    public static class PlayModeTestRunner
    {
        public static readonly string ResultPath =
            Path.Combine(Directory.GetParent(Application.dataPath).FullName, "Temp", "OpenFairyPlayModeResults.txt");
        ...
        [MenuItem("Tools/OpenFairy/Run PlayMode Tests")]
