...
{
    // 复刻 FairyGUI GTextInput：可编辑文本，基于 uGUI InputField。显示用 OpenFairy.UGUI.TextField，prompt 用 placeholder TextField。
    // 已知限制：InputField 的光标定位依赖 textComponent 的 TextGenerator，而 OpenFairy.UGUI.TextField 走自绘布局，故光标像素位置可能略偏；
